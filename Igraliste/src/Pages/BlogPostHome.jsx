    ...
    <section className="py-4 bg-gray-200">
      <article className="flex  flex-wrap justify-center bg-gray-200 mx-2    ">
        {lastThreeBlogs.map((blog) => (
          <div key={blog.id} className="w-full sm:w-1/2 md:w-2/3 lg:w-[30%] xl:w-[30%] p-2 bg-white mb-2 mx-2 hover:scale-105 transition-transform duration-300 ease-in-out    ">
            <Link
